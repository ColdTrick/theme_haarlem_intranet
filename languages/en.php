...
$english = array(
	...
	"theme_haarlem_intranet:menu:site:organisation" => "Organisation",
	"theme_haarlem_intranet:menu:site:groups" => "Groups",
	"theme_haarlem_intranet:menu:site:knowledge" => "Knowledge",
	"theme_haarlem_intranet:menu:site:personnel" => "Personnel",
	...
	"theme_haarlem_intranet:owner_block:group:related:hoofdafdeling" => "Subdepartments of this maindep.",
	...
	"theme_haarlem_intranet:color:red" => "Signal Red",
	"theme_haarlem_intranet:color:darkred" => "Dark Red",
	"theme_haarlem_intranet:color:orange" => "Orange",
	"theme_haarlem_intranet:color:darkblue" => "Dark Blue",
	...
	"theme_haarlem_intranet:settings:group_leave_retention" => "Number of days before a user is removed from the groups after leaving the site",
